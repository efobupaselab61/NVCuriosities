...
public struct NVSignalProbePayload: Codable, Equatable, Sendable {
...
public struct NVSignalLaunchPayload: Codable, Equatable, Sendable {
...
public struct NVSignalLaunchDecision: Decodable, Equatable, Sendable {
...
private extension KeyedDecodingContainer where Key == NVSignalLaunchDecision.CodingKeys {
