...
public struct NVSignalBrowserContainer: UIViewRepresentable {
    public let configuration: NVSignalConfiguration
    @ObservedObject public var session: NVSignalBrowserSessionModel

    public init(configuration: NVSignalConfiguration, session: NVSignalBrowserSessionModel) {
    ...
    public func makeUIView(context: Context) -> WKWebView {
        let webView = WKWebView(frame: .zero, configuration: NVSignalBrowserRuntime.makeConfiguration())
    ...
    public final class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate, UIDocumentPickerDelegate {
        fileprivate let session: NVSignalBrowserSessionModel
        private var fileSelectionHandler: (([URL]?) -> Void)?

        init(session: NVSignalBrowserSessionModel) {
            self.session = session
        }
        ...
        public func webView(
            ...
            guard let presenter = webView.nvSignalTopPresenter() else {
                fileSelectionHandler = nil
...
private extension WKWebView {
    func nvSignalTopPresenter() -> UIViewController? {
...
@MainActor
public final class NVSignalBrowserSessionModel: ObservableObject {
